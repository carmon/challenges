...
var StickyNote = React.createClass({displayName: "StickyNote",
    propTypes: {
    ...
    render: function() {
        ...
        return (
          React.createElement("div", {className: "stickyNote", style: divStyle, onClick: this.handleClick, onDoubleClick: this.handleDoubleClick, onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut}, 
            React.createElement("textarea", {defaultValue: this.props.text, onChange: this.handleChangeChild, onFocus: this.handleFocus, style: textStyle})
          )
        );
    }
});
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        ...
        var stickys = this.state.data.map(function (note, i) {
          ...
          return (
            React.createElement(StickyNote, {my_id: i, is_selected: st, text: note.text, pos: note.pos, onChange: self.handleStickyChange, onSelect: self.handleStickySelect, key: i})
          );
        });
        return (
          React.createElement("div", {className: "miniMural", style: divStyle, onClick: this.handleClick, onDoubleClick: this.handleDoubleClick}, 
            React.createElement(Clipboard, {value: this.state.copied, onCopy: this.handleCopy, onPaste: this.handlePaste, onMouseMove: this.handleMouseMove, onAltCopy: this.handleAltCopy}), 
            stickys
          )
        );
    }
...
},{"./clipboard-custom.jsx":161,"react":158,"react-dom":2}],160:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
ReactDOM.render(
	React.createElement(MiniMural, {data: data}),
    document.getElementById('example')
);

},{"./MiniMural.jsx":159,"react":158,"react-dom":2}],161:[function(require,module,exports){
var React = require("react");
var ReactDOM = require("react-dom");
...
},{"react":158,"react-dom":2,"react/lib/Object.assign":24}]},{},[160]);
